...
- Monaco 기반 diff·도움말·주의사항·validation 결과 UI
...
- 최초 adapter는 Nginx이며 PHP-FPM·Redis는 별도 fixture와 VM gate 뒤 승격
...
- 기존 OpenSSH 기반 SFTP list/read/download/upload와 Monaco text editor
...
- Redis 설정
- Certbot guided issuance·Nginx attach는 해당 operation fault gate 전
- UFW 규칙
