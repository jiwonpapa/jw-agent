...
- 한 JW session당 file session 1개, 전체 8개이며 로그인 session이 유효하고 사용자가 끊지 않는 동안 route 이동과 idle로 종료하지 않음
...
- wrong JW session/origin/ingress, replay after close, logout/revoke/daemon restart 거부
