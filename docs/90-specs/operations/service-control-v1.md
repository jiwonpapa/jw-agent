...
- 최초 allowlist: `nginx.service`, `apache2.service`, `php8.3-fpm.service`,
  `mysql.service`, `mariadb.service`, `redis-server.service`
...
- VM에서 Nginx·PHP-FPM start/stop/restart와 관리 접속 지속성을 검증
