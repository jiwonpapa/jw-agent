...
- Ubuntu 24.04 VM에 `jw-agent_0.2.0~p2.17_amd64.deb`를 설치했고 SHA-256은 `283bf2b8d3465e22ac38beb696014a3cea3e0b059b54a71238780aec8b7c3b5f`입니다.
...
웹 terminal·SFTP session owner는 route component에서 authenticated app shell로 이동했습니다. 메뉴 이동은 연결을 닫지 않으며 terminal·SFTP 자체 max lifetime은 `0`입니다. 명시적 종료·logout·로그인 session 만료·연결 상실·서버 재시작은 계속 종료 경계입니다. 같은 ticket/token을 재사용하는 browser gate와 p2.17 실제 OpenSSH endpoint VM gate가 통과했습니다.
