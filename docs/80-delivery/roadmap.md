...
- `p2-local` 19개, `p2-browser` 8개 gate와 Playwright 23개 scenario가 PASS했습니다.
- `p2-vm` 20개 gate에서 Nginx fault matrix, forensic lockdown, Certbot one-shot boundary·sanitized inventory·G1 renewal·guided issuance CA 실패와 보호 vhost G2 attach 원복을 검증했습니다.
- Ubuntu 24.04 VM에 `jw-agent_0.2.0~p2.7_amd64.deb`를 설치했고 SHA-256은 `87ac41e0ac34c4e1d0a4af66dc5af8de904b5eda4bbfc19c3608a6affe0edfa6`입니다.
