...
- `p2-vm` 15개 gate에서 site-state와 managed-config 성공·no-op·문법/reload 실패 원복·외부 변경 보존·비활성 차단·디스크 guard·forensic lockdown을 검증했습니다.
- Ubuntu 24.04 VM에 `jw-agent_0.2.0~p2.2_amd64.deb`를 설치했고 SHA-256은 `6a4772b53829f5f6150baa6c5d6cef6e115146d9b5e23fadc6e8138528916850`입니다.
