...
- `p2-local` 19개, `p2-browser` 8개, Playwright 20개, `p2-vm` 17개 gate가 PASS했습니다.
- VM package는 `jw-agent_0.2.0~p2.4_amd64.deb`, SHA-256 `47d8e57718c15c8933fc10e7b00bed5b5111791378e8e1dbbff91039103de9db`입니다.
...
- `jw-certd` one-shot network privilege boundary와 sanitized certificate inventory는 `VM_PASS`이며 Certbot 발급·attach API는 아직 노출하지 않습니다.
