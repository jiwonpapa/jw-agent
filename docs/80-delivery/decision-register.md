...
- 권한·프로세스 경계별 runtime crate와 단일 xtask
- 비권한 Rust `jw-edge` 9443 기본 ingress, 선택적 Nginx+Certbot 443 호환 ingress, agentd UDS
...
- VM package는 `jw-agent_0.2.0~p2.24_amd64.deb`, SHA-256 `9c3779180facc4cd4d4e83a17b773bb77488b401d8d138aa131bfb4cfd3d2ffc`입니다.
