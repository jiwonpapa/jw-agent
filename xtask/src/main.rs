...
const GATES: &[Gate] = &[
    ...
    Gate {
        ...
        owner: "Service Maintainer",
        scope: "typed Nginx and PHP-FPM lifecycle plan, approval, execution, and state read-back",
        inputs: "installed P2 package, public TLS API, administrative PAM fixture, Nginx, and PHP-FPM",
        lanes: P2_VM_LANES,
        timeout_seconds: 180,
        evidence: "Nginx reload and PHP-FPM restart, stop, and start receipts plus management continuity passed",
    ...
    Gate {
        ...
        lanes: P2_VM_LANES,
        timeout_seconds: 300,
        evidence: "Nginx save and rollback matrix plus PHP-FPM observation, save, manual restore, syntax rollback, and continuity passed",
