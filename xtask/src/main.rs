...
const P2_REQUIRED_PATHS: &[&str] = &[
    ...
    "apps/web/src/features/firewall/ufw-screen.tsx",
    "apps/web/src/features/files/files-screen.tsx",
    "apps/web/src/shared/ui/code-editor.tsx",
    "apps/web/src/shared/ui/monaco-editor-core.d.ts",
    "apps/web/src/shared/ui/monaco-editor.worker.ts",
    "apps/web/src/shared/ui/monaco-runtime.ts",
    "apps/web/public/vendor/monaco/LICENSE",
    "apps/web/public/vendor/monaco/ThirdPartyNotices.txt",
    "apps/web/public/vendor/monaco/assets/monaco-editor.worker.js",
    "apps/web/public/vendor/monaco/monaco-runtime.css",
    "apps/web/public/vendor/monaco/monaco-runtime.js",
    "apps/web/vite.monaco.config.ts",
    ...
    "crates/jw-agentd/src/service_config_inventory.rs",
    ...
    "crates/jw-contracts/src/operation/diagnostic.rs",
    ...
    "crates/jw-opsd/migrations/0007_managed_config_diagnostics.sql",
    "crates/jw-opsd/src/apache_diagnostic.rs",
    "crates/jw-opsd/src/config.rs",
    "crates/jw-opsd/src/config_diagnostic.rs",
    "crates/jw-opsd/src/certificate.rs",
    "crates/jw-opsd/src/digest.rs",
    "crates/jw-opsd/src/engine.rs",
    "crates/jw-opsd/src/engine/managed_config_rollback.rs",
    "crates/jw-opsd/src/engine/managed_config_plan.rs",
    "crates/jw-opsd/src/engine/service_operation.rs",
    "crates/jw-opsd/src/error.rs",
    "crates/jw-opsd/src/ledger.rs",
    "crates/jw-opsd/src/ledger/diagnostics.rs",
    ...
    "crates/jw-opsd/src/ufw.rs",
    "docs/90-specs/adr/0019-managed-service-config-and-firewall-boundary.md",
    "docs/90-specs/adr/0020-monaco-desktop-config-workspace.md",
    "docs/90-specs/operations/managed-config-diagnostic-v1.md",
    "docs/90-specs/operations/ufw-rule-v1.md",
    "packaging/systemd/jw-edge.service",
    "xtask/src/edge_boundary.rs",
    "xtask/src/vm/independent_edge.rs",
    "xtask/src/vm/apache.rs",
...
const GATES: &[Gate] = &[
    ...
    Gate {
        ...
        lanes: P2_LOCAL_LANES,
        timeout_seconds: 3,
        evidence: "fixed OpenSSH subsystem, route-independent login-bound sessions, bounded read allowlist, PAM-planned fsync/atomic upload, canonical home confinement, metadata-only fail-closed audit, and no opsd path passed",
    ...
    Gate {
        ...
        owner: "Service Maintainer",
        scope: "typed Nginx, Apache, and PHP-FPM lifecycle plan, approval, execution, and state read-back",
        inputs: "installed P2 package, public TLS API, administrative PAM fixture, Nginx, Apache, and PHP-FPM",
        lanes: P2_VM_LANES,
        timeout_seconds: 180,
        evidence: "Nginx reload, Apache reload/restart/stop/start, and PHP-FPM restart/stop/start receipts plus management continuity passed",
        failure_policy: "fail lane on arbitrary unit exposure, stale state, missing receipt, wrong final state, or lost management ingress",
        run: vm::service_control::gate_p2_service_control,
    },
    Gate {
    ...
    Gate {
        ...
        scope: "Nginx, Apache, and PHP-FPM config G2 plan, atomic replace, validation, reload, and exact rollback",
        inputs: "installed P2 package, public TLS API, PAM fixture, active Nginx, Apache, and PHP-FPM resources, opsd ledger",
        lanes: P2_VM_LANES,
        timeout_seconds: 300,
        evidence: "Nginx save and rollback matrix plus Apache and PHP-FPM observation, save, syntax rollback, restore, and continuity passed",
    ...
    Gate {
        id: "VM-P2-UFW-RULE",
        owner: "Firewall Maintainers",
        scope: "typed product-owned UFW rule plan, approval, apply, delete, protected-port rejection, and drift cancellation",
        inputs: "installed P2 package, public TLS API, administrative PAM fixture, UFW, SSH, and independent edge",
        lanes: P2_VM_LANES,
        timeout_seconds: 240,
        evidence: "owned allow and delete, protected SSH denial rejection, stale plan cancellation, and ingress continuity passed",
        failure_policy: "fail lane on arbitrary rule exposure, management-port denial, stale apply, missing receipt, or lost management ingress",
        run: vm::ufw::gate_p2_ufw_rule,
    },
    Gate {
    ...
    Gate {
        ...
        owner: "Security Maintainer",
        scope: "recovery-only TOTP enrollment, bounded administrative-mode step-up, replay denial, and recovery reset",
        inputs: "installed P2 package, recovery ingress, PAM fixture, encrypted agentd state, and typed Nginx no-op",
        lanes: P2_VM_LANES,
        timeout_seconds: 240,
        evidence: "two consecutive codes, risky-operation policy, PAM plus TOTP management mode, time-step replay denial, reset, and encrypted-at-rest cleanup passed",
        failure_policy: "fail lane on public enrollment, weak key storage, skipped factor, code replay, retained recovery material, or incomplete reset",
