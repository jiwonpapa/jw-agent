...
현재 단계는 `P2 Safe local operations`입니다. durable safety kernel, Nginx G2 작업, Certbot one-shot 경계와 인증서 조회를 Ubuntu VM에서 검증했습니다. Certbot 발급·attach와 terminal·SFTP를 포함한 P2 전체 완료는 아직 주장하지 않습니다.
