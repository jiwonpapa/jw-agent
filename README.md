...
- recovery ingress 전용 TOTP 등록·복구 코드 초기화, PAM+TOTP 관리 모드와 고위험 exact-plan 승인
...
- 호스트·Nginx·PHP-FPM 관찰, typed site state, 활성 allowlisted Nginx와 표준 PHP 8.3 FPM `php.ini` 설정 편집
